...
Welcome to `nerd-hugs`, a heartwarming unit testing library designed to foster camaraderie among modules within your monolithic Java application. The mission? To simplify the definition and enforcement of dependencies, all while spreading the joy of clean, organized code. Whether you're a seasoned code whisperer 🧙‍♀️ or a budding enthusiast, this repo invites you to explore the joy of intentional design and tidy structure.
